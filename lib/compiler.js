...
module.exports = (function() {
  ...
  exports.run = function*(config, options, previousResults) {
    var app, appConfig, key, pack, packConfig, ref, ref1, ref2, ref3, ref4, ref5, result, results, running, value;
    ...
    for (app in config) {
      appConfig = config[app];
      if (!(((options != null ? options.onlyApp : void 0) == null) || app === options.onlyApp)) {
        continue;
      }
  ...
  exports.runApp = function*(app, config, options) {
    ...
    yields = [];
    if (((options != null ? options.onlyPart : void 0) == null) || 'javascripts' === options.onlyPart) {
      yields.push(this.runAppJs(app, config, result, options));
    }
    if (((options != null ? options.onlyPart : void 0) == null) || 'stylesheets' === options.onlyPart) {
      yields.push(this.runAppCss(app, config, result, options));
    }
    if (((options != null ? options.onlyPart : void 0) == null) || 'routing' === options.onlyPart) {
