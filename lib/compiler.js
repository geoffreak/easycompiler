...
var CSS, Deps, JS, Route, Versioner, _, co, debug, fs, path,
...
module.exports = (function() {
  ...
  exports.run = function*(config, options, previousResults) {
    var app, appConfig, key, pack, packConfig, ref, ref1, ref2, ref3, ref4, ref5, ref6, result, results, running, value, versioner;
    ...
    for (app in config) {
      ...
      result = (yield this.runApp(app, appConfig, options, versioner));
      if (results[app] == null) {
        results[app] = {};
      }
      for (key in result) {
  ...
  exports.runApp = function*(app, config, options, versioner) {
    ...
    if (!(options != null ? (ref = options.onlyPart) != null ? ref.length : void 0 : void 0) || options.onlyPart.indexOf('javascripts') !== -1) {
      yields.push(this.runAppJs(app, config, result, versioner));
    }
    if (!(options != null ? (ref1 = options.onlyPart) != null ? ref1.length : void 0 : void 0) || options.onlyPart.indexOf('stylesheets') !== -1) {
      yields.push(this.runAppCss(app, config, result, versioner));
    }
    if (!(options != null ? (ref2 = options.onlyPart) != null ? ref2.length : void 0 : void 0) || options.onlyPart.indexOf('routing') !== -1) {
      yields.push(this.runAppRouting(app, config, result, versioner));
    }
    (yield yields);
    return result;
  };

  exports.runAppJs = function*(app, config, result, versioner) {
    var deps, files, options, pack, packConfig, ref, ref1, ref2;
    if (config != null ? (ref = config.javascripts) != null ? ref.packages : void 0 : void 0) {
      ...
      for (pack in ref1) {
        ...
        if (result.javascripts[pack] == null) {
          continue;
        }
  ...
  exports.runAppCss = function*(app, config, result, versioner) {
    var deps, files, options, pack, packConfig, ref, ref1, ref2;
    if (config != null ? (ref = config.stylesheets) != null ? ref.packages : void 0 : void 0) {
      ...
      for (pack in ref1) {
        ...
        if (result.stylesheets[pack] == null) {
          continue;
        }
  ...
  exports.runAppRouting = function*(app, config, result, versioner) {
