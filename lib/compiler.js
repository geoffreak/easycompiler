...
module.exports = (function() {
  ...
  exports.run = function*(config) {
    var app, appConfig, results, _ref, _ref1;
    results = {};
    for (app in config) {
    ...
    for (app in config) {
      appConfig = config[app];
      results[app] = (yield this.runApp(app, appConfig));
    }
    return results;
  };

  exports.runApp = function*(app, config) {
    var files, options, pack, packConfig, result, _ref, _ref1, _ref2, _ref3;
    result = {
      javascripts: {},
      stylesheets: {}
    };
    if (config != null ? (_ref = config.javascripts) != null ? _ref.packages : void 0 : void 0) {
      _ref1 = config.javascripts.packages;
      for (pack in _ref1) {
        packConfig = _ref1[pack];
    ...
    if (config != null ? (_ref2 = config.stylesheets) != null ? _ref2.packages : void 0 : void 0) {
      _ref3 = config.stylesheets.packages;
      for (pack in _ref3) {
